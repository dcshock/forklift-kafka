...
public class StatsCollector {
    ...
    public void invalid(MessageRunnable mr) {
        ...
        mr.getMsg().getProperties().put("forklift-stats-validating-total",
                                        String.valueOf((System.currentTimeMillis() -
                                                        Long.parseLong(mr.getMsg()
                                                                         .getProperties()
                                                                         .get("forklift-stats-validating")))));
    }
    ...
    private void setProp(MessageRunnable mr, String prop) {
        mr.getMsg().getProperties().put("forklift-stats-" + prop, String.valueOf(System.currentTimeMillis()));
    }
}
